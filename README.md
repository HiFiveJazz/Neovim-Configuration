...
***Arch Linux***
```md
sudo pacman -S --noconfirm wl-clipboard neovim deno lazygit sox cargo ripgrep noto-fonts-emoji imagemagick curl shfmt luarocks lua51 hyperfine yazi sshfs npm jdk-openjdk python tree-sitter-cli  
```
